...
| **date_range** | [**BookingAvailabilityUpdateDateRange**](BookingAvailabilityUpdateDateRange.md) |  |  |
| **available_rooms** | **Integer** | Rooms to sell (&#x60;roomstosell&#x60;). &#x60;0&#x60; blocks the room for the range. Omit it to leave inventory alone — &#x60;0&#x60; is a stop-sell, not a no-op. | [optional] |
