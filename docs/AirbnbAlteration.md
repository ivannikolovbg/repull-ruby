...
| ---- | ---- | ----------- | ----- |
| **id** | **Integer** | Internal Repull mirror-row id (not the Airbnb alteration id — use &#x60;alterationId&#x60; for the &#x60;{id}&#x60; path param on the get / accept / decline routes). | [optional] |
