...
# Unit tests for Repull::PaginatedResponsePagination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Repull::PaginatedResponsePagination do
  #let(:instance) { Repull::PaginatedResponsePagination.new }

  describe 'test an instance of PaginatedResponsePagination' do
    it 'should create an instance of PaginatedResponsePagination' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Repull::PaginatedResponsePagination)
    end
  end
