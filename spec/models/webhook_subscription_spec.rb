...
# Unit tests for Repull::WebhookSubscription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Repull::WebhookSubscription do
  #let(:instance) { Repull::WebhookSubscription.new }

  describe 'test an instance of WebhookSubscription' do
    it 'should create an instance of WebhookSubscription' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Repull::WebhookSubscription)
    end
  end
