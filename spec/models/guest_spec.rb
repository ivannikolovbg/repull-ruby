...
# Unit tests for Repull::Guest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Repull::Guest do
  #let(:instance) { Repull::Guest.new }

  describe 'test an instance of Guest' do
    it 'should create an instance of Guest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Repull::Guest)
    end
  end
  ...
  describe 'test attribute "total_stays"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
