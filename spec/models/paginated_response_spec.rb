...
# Unit tests for Repull::PaginatedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Repull::PaginatedResponse do
  #let(:instance) { Repull::PaginatedResponse.new }

  describe 'test an instance of PaginatedResponse' do
    it 'should create an instance of PaginatedResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Repull::PaginatedResponse)
    end
  end
