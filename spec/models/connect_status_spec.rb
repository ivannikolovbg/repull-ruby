...
# Unit tests for Repull::ConnectStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Repull::ConnectStatus do
  #let(:instance) { Repull::ConnectStatus.new }

  describe 'test an instance of ConnectStatus' do
    it 'should create an instance of ConnectStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Repull::ConnectStatus)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["active", "inactive", "error"])
