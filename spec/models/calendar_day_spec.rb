...
# Unit tests for Repull::CalendarDay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Repull::CalendarDay do
  #let(:instance) { Repull::CalendarDay.new }

  describe 'test an instance of CalendarDay' do
    it 'should create an instance of CalendarDay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Repull::CalendarDay)
    end
  end
  ...
  describe 'test attribute "min_nights"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
