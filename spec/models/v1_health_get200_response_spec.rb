...
# Unit tests for Repull::V1HealthGet200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Repull::V1HealthGet200Response do
  #let(:instance) { Repull::V1HealthGet200Response.new }

  describe 'test an instance of V1HealthGet200Response' do
    it 'should create an instance of V1HealthGet200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Repull::V1HealthGet200Response)
    end
  end
