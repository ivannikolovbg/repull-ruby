...
# Unit tests for Repull::V1AiPost200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Repull::V1AiPost200Response do
  #let(:instance) { Repull::V1AiPost200Response.new }

  describe 'test an instance of V1AiPost200Response' do
    it 'should create an instance of V1AiPost200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Repull::V1AiPost200Response)
    end
  end
