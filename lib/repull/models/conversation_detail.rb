...
module Repull
  ...
  class ConversationDetail < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'external_thread_id')
        self.external_thread_id = attributes[:'external_thread_id']
      end
