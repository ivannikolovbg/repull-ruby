...
module Repull
  ...
  class Property < ApiModelBase
    ...
    # Detail endpoint only. Decimal degrees, as a string.
    ...
    # Last time this property record changed. Feed the newest value you have seen back as `?updated_since=` to poll for changes only. List endpoint (`GET /v1/properties`) only.
