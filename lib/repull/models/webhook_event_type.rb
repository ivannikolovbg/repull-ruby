...
module Repull
  class WebhookEventType
    ...
    def self.all_vars
      @all_vars ||= [RESERVATION_CREATED, RESERVATION_UPDATED, RESERVATION_CANCELLED, RESERVATION_MESSAGE_RECEIVED, RESERVATION_ALTERATION_CREATED, RESERVATION_ALTERATION_RESPONDED, LISTING_CREATED, LISTING_UPDATED, LISTING_DELETED, CALENDAR_UPDATED, ACCOUNT_CREATED, ACCOUNT_DISCONNECTED, REVIEW_CREATED, REVIEW_RESPONDED, AI_OPERATION_COMPLETED, AI_OPERATION_FAILED, PAYMENT_COMPLETED, PAYMENT_REFUNDED, REPULL_PING].freeze
    end
