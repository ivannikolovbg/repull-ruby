  ...
  class PreapproveConversation201Response < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Repull::PreapproveConversation201Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Repull::PreapproveConversation201Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'block_instant_booking')
        ...
        self.block_instant_booking = nil
      end
    ...
    def list_invalid_properties
      ...
      if @block_instant_booking.nil?
        invalid_properties.push('invalid value for "block_instant_booking", block_instant_booking cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @block_instant_booking.nil?
      true
    end
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["pre_approved"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] block_instant_booking Value to be assigned
    def block_instant_booking=(block_instant_booking)
      if block_instant_booking.nil?
        fail ArgumentError, 'block_instant_booking cannot be nil'
      end
