...
module Repull
  class Guest < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'total_stays')
        self.total_stays = attributes[:'total_stays']
      end
    ...
    def hash
      [id, first_name, last_name, email, phone, total_stays, total_revenue].hash
    end
