...
module Repull
  class GetUsageSummary200Response < ApiModelBase
    attr_accessor :tier
    ...
    attr_accessor :status_distribution
    ...
    def self.openapi_types
      {
        ...
        :'status_distribution' => :'GetUsageSummary200ResponseStatusDistribution',
        :'totals' => :'GetUsageSummary200ResponseTotals',
        :'range' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Repull::GetUsageSummary200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Repull::GetUsageSummary200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'status_distribution')
        self.status_distribution = attributes[:'status_distribution']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          timeline == o.timeline &&
          status_distribution == o.status_distribution &&
          totals == o.totals &&
          range == o.range
    end
