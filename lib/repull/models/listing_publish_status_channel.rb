...
module Repull
  class ListingPublishStatusChannel < ApiModelBase
    ...
    attr_accessor :dirty_fields

    attr_accessor :platform_has_changes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Repull::ListingPublishStatusChannel` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Repull::ListingPublishStatusChannel`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'last_pulled_at')
        self.last_pulled_at = attributes[:'last_pulled_at']
      end

      if attributes.key?(:'dirty_fields')
        if (value = attributes[:'dirty_fields']).is_a?(Array)
          self.dirty_fields = value
        end
      end

      if attributes.key?(:'platform_has_changes')
        self.platform_has_changes = attributes[:'platform_has_changes']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          platform_has_changes == o.platform_has_changes
    end
